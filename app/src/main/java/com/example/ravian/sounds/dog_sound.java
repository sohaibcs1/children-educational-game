...
public class dog_sound extends AppCompatActivity {
    Button b1;
    ImageView g1,g2,g3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySound = MediaPlayer.create(this, R.raw.d);
        mySound2=MediaPlayer.create(this,R.raw.e);
        mySound3=MediaPlayer.create(this,R.raw.f);
    }
