...
public class gun_sound extends AppCompatActivity {
    Button b1;
    ImageView g1,g2,g3;
   ...
   protected void onPause(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gun_sound);
        ...
        mySound2=MediaPlayer.create(this,R.raw.b);
        mySound3=MediaPlayer.create(this,R.raw.c);
    }
